...
class Profile(models.Model):
    ...
    avatar_top = models.CharField(max_length=50, default="short_hair")
    ...
    avatar_hair_color = models.CharField(max_length=50, default="black")
    avatar_accessory = models.CharField(max_length=50, default="none")
    avatar_clothing = models.CharField(max_length=50, default="shirt")
    avatar_clothing_color = models.CharField(max_length=50, default="blue")
